...
# Expose supported payment types by looking at the available modules in src/fields
...
# Pull certain environment variables into src/generated/env.ts
...
# Also add the current git revision
echo '  "GIT_REV": "'$(git rev-parse HEAD)'",'                                    >> $file
echo '};'                                                                         >> $file
echo "Generated $file"
